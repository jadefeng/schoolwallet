...
class GoodsControllerTest < ActionController::TestCase
  ...
  test "should create good" do
    assert_difference('Good.count') do
      post :create, good: { category: @good.category, image_url: @good.image_url, name: @good.name, price: @good.price }
    end
  ...
  test "should update good" do
    patch :update, id: @good, good: { category: @good.category, image_url: @good.image_url, name: @good.name, price: @good.price }
    assert_redirected_to good_path(assigns(:good))
  end
