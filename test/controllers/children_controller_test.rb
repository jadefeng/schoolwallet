...
class ChildrenControllerTest < ActionController::TestCase
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post :create, child: { balance: @child.balance, image_url: @child.image_url, name: @child.name, school: @child.school, user_id: @child.user_id }
    end
  ...
  test "should update child" do
    patch :update, id: @child, child: { balance: @child.balance, image_url: @child.image_url, name: @child.name, school: @child.school, user_id: @child.user_id }
    assert_redirected_to child_path(assigns(:child))
  end
